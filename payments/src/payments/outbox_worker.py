...
from payments.config import get_settings, utc_now
from payments.domain.entities import PaymentEventType
...
async def run_connected_worker() -> None:
    ...
    async with connection:
        ...
        while True:
            ...
            await observe_outbox_age(SessionFactory, OutboxEventModel, utc_now(), "payments")
            touch_heartbeat("/tmp/flashmarket-heartbeat.json", "payments_outbox")
            await asyncio.sleep(settings.outbox_poll_interval_seconds)
