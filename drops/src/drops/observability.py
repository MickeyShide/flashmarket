"""Observability helpers for drops service: logging, request middleware, Prometheus metrics."""
...
HTTP_REQUESTS = Counter(
    "drops_http_requests_total",
    "Total HTTP requests",
    labelnames=("method", "route", "status"),
)
HTTP_DURATION = Histogram(
    "drops_http_request_duration_seconds",
    "HTTP request duration",
    labelnames=("method", "route"),
)
HTTP_IN_PROGRESS = Gauge(
    "drops_http_requests_in_progress",
