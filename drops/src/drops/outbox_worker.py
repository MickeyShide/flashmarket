...
ROUTED_EVENTS = {"drops.DropStarted"}
...
async def run_connected_worker() -> None:
    ...
    async with connection:
        ...
        while True:
            ...
            await observe_outbox_age(SessionFactory, OutboxEventModel, utc_now(), "drops")
            touch_heartbeat("/tmp/flashmarket-heartbeat.json", "drops_outbox")
            await asyncio.sleep(settings.outbox_poll_interval_seconds)
