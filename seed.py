...
def main():
    ...
    products = [
        {
            "name": "SIBERIA BOMBER in BLACK",
            "description": "- 100%-хлопковый вощёный деним\n- выдержит до -25\n- наполнитель - синтепон+синтепух\n- брендированный пуллер",
            "price": "12000.00",
            "currency": "RUB",
            "category_id": cat_ids[0] if len(cat_ids) > 0 else cat_ids[0],
            "brand_id": b_marcelo,
            "status": "ACTIVE",
            "cover_image": "https://images.unsplash.com/photo-1544441893-675973e31985?auto=format&fit=crop&w=800&q=80",
        },
        {
            "name": "SIBERIA BOMBER in BLUE",
            "description": "- 100%-хлопковый вощёный деним\n- выдержит до -25\n- сине-металлический оттенок вощёной ткани\n- фурнитура Marcelo Miracles",
            "price": "12000.00",
            "currency": "RUB",
            "category_id": cat_ids[0] if len(cat_ids) > 0 else cat_ids[0],
            "brand_id": b_marcelo,
            "status": "ACTIVE",
            "cover_image": "https://images.unsplash.com/photo-1551028719-00167b16eac5?auto=format&fit=crop&w=800&q=80",
        },
        {
            "name": "EDEC FUR COAT in RED",
            "description": "- Искусственный экологичный эко-мех премиум класса\n- Объёмный капюшон и брендированный подклад\n- Яркий насыщенный красный цвет",
            "price": "50000.00",
            "currency": "RUB",
            "category_id": cat_ids[0] if len(cat_ids) > 0 else cat_ids[0],
            "brand_id": b_marcelo,
            "status": "ACTIVE",
            "cover_image": "https://images.unsplash.com/photo-1539533018447-63fcce2678e3?auto=format&fit=crop&w=800&q=80",
        },
        {
            "name": "REVERSIBLE FUR ZIP HOODIE in BLACK/BROWN",
            "description": "- Двусторонняя куртка-зипка с капюшоном\n- Леопардовый искусственный мех изнутри\n- Плотный оверсайз хлопок 450 г/м²",
            "price": "12900.00",
            "currency": "RUB",
            "category_id": cat_ids[1] if len(cat_ids) > 1 else cat_ids[0],
            "brand_id": b_marcelo,
            "status": "ACTIVE",
            "cover_image": "https://images.unsplash.com/photo-1556905055-8f358a7a47b2?auto=format&fit=crop&w=800&q=80",
        },
        {
            "name": "REVERSIBLE FUR ZIP HOODIE in GREY",
            "description": "- Двусторонняя толстовка меланжевого серого оттенка\n- Двусторонний замок с металлическим крестом\n- Леопардовый подклад",
            "price": "12900.00",
            "currency": "RUB",
            "category_id": cat_ids[1] if len(cat_ids) > 1 else cat_ids[0],
            "brand_id": b_marcelo,
            "status": "ACTIVE",
            "cover_image": "https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=800&q=80",
        },
        {
            "name": "10 YEARS GOTHIC LOGO HOODIE in BLACK",
            "description": "- Юбилейная коллекция 10 Years Marcelo Miracles\n- Готический вышитый логотип на груди\n- Тяжёлый хлопок 480 г/м²",
            "price": "10000.00",
            "currency": "RUB",
            "category_id": cat_ids[1] if len(cat_ids) > 1 else cat_ids[0],
            "brand_id": b_marcelo,
        ...
        },
        {
            ...
            "description": "- Меланжевый светло-серый цвет\n- Готический вышитый логотип 10 Years\n- Объёмный карман-кенгуру",
            "price": "10000.00",
            "currency": "RUB",
            "category_id": cat_ids[1] if len(cat_ids) > 1 else cat_ids[0],
            "brand_id": b_marcelo,
            "status": "ACTIVE",
            "cover_image": "https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?auto=format&fit=crop&w=800&q=80",
        },
        {
            "name": "REVERSIBLE FUR ZIP HOODIE in BLACK",
            "description": "- Чёрная двусторонняя худи-зипка премиум издания\n- Мягкий эко-мех изнутри\n- Замок-крест",
            "price": "19000.00",
            "currency": "RUB",
            "category_id": cat_ids[1] if len(cat_ids) > 1 else cat_ids[0],
            "brand_id": b_marcelo,
        ...
        {
            "name": "REVERSIBLE FUR ZIP HOODIE in BROWN",
            "description": "- Глубокий шоколадно-коричневый цвет\n- Двусторонний мягкий эко-мех\n- Усиленные манжеты",
            "price": "19000.00",
            "currency": "RUB",
            "category_id": cat_ids[1] if len(cat_ids) > 1 else cat_ids[0],
            "brand_id": b_marcelo,
